    ...
    return (  
         <Card className="bg-white rounded-xl shadow-md relative">
            ...
            <div className="p-4">
              ...
              <div
                className="flex justify-center text-green-900 gap-4 text-sm mb-4"
              >
                <p> <FaMoneyBill className="inline-block mr-1" /> weekly</p>
              <p> <FaMoneyBill className="inline-block mr-1" /> Monthly </p>
